...
from .config_bi_so100_follower import BiSO100RemoteFollowerConfig

logger = logging.getLogger(__name__)


class BiSO100RemoteFollower(RemoteRobot):
    """
    Remote Bimanual SO-100 Follower via WebRTC.

    Receives observations over LiveKit data channel and publishes actions.
    """

    config_class = BiSO100RemoteFollowerConfig
    name = "bi_so100_remote_follower"

    def __init__(self, config: BiSO100RemoteFollowerConfig):
